  ...
  if (isOpen && showFeedback) {
    ...
    body = (
      <div className={classes.paper}>
        ...
        <Typography variant="body1" className={classes.trySaying}>Try saying: &quot;Give me the latest <strong>Business</strong> news&quot;</Typography>
        <Divider />
        <div className={classes.infoContainer}>
        ...
        <Typography variant="body1" className={classes.trySaying}>Try saying: &quot;What&apos;s up with <strong>PlayStation 5</strong>&quot;</Typography>
        <Divider />
        <div className={classes.infoContainer}>
        ...
        <Typography variant="body1" className={classes.trySaying}>Try saying: &quot;Give me the news from <strong>CNN</strong>&quot;</Typography>
      </div>
    );
  }
